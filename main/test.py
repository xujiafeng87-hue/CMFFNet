...
EVALUATION_TXT = "evaluation5_8_2.txt"
...
def count_parameters_and_flops(model, input_size=(1, 3, 128, 128)):
    ...
    return total_params, trainable_params, non_trainable_params, flops, param_size_mb
...
def test_acc(model, device):
    ...
    total_params, trainable_params, non_trainable_params, flops, param_size_mb = count_parameters_and_flops(
        model, input_size=(1, 3, 128, 128)
    )
